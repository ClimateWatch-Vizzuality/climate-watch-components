module.exports = (function(t) {
  ...
  '+0Bn': function(t, e) {
    ...
    n = I(function(t, e) {
      ...
      return ~~t;
    }, C = Math.round, E = Math.ceil, j = Math.floor, P = function(t) {
      return t != t;
    }, k = function(t) {
      return t % 2 == 0;
    }, N = function(t) {
  ...
  '5QKM': function(t, e) {
    t.exports = {
      btnInfo: 'cw__info-button-styles_btnInfo',
      btnInfoActive: 'cw__info-button-styles_btnInfoActive',
      box: 'cw__info-button-styles_box'
    };
  },
  '5xLi': function(t, e) {
    t.exports = {
  ...
  Gmfh: function(t, e, n) {
            ...
            return i.default.createElement(
              u.default,
              {
                className: (0, s.default)(
                  p.default.btnInfo,
                  h.btnInfo,
                  a ? p.default.btnInfoActive : '',
                  (t = {}, e = p.default.box, n = d, e in t
                    ? Object.defineProperty(t, e, {
                      value: n,
                      enumerable: !0,
                      configurable: !0,
    ...
    d.propTypes = {
      infoOpen: a.default.bool.isRequired,
      handleInfoClick: a.default.func.isRequired,
      square: a.default.bool,
      box: a.default.bool,
      theme: a.default.shape({
        btnInfo: a.default.string,
        icon: a.default.string
      })
    }, d.defaultProps = { square: !1, box: !1, theme: {} }, e.default = d;
  },
  GoyQ: function(t, e) {
    t.exports = function(t) {
      var e = typeof t;
  ...
  IaFt: function(t, e, n) {
    (function(e) {
      ...
      n = function() {
        ...
        var S = r.xlink.uri, T = 'xlink:href', C = /[{}|\\\^\[\]`"<>]/g;
        function E(t) {
  ...
  'd/KL': function(t, e, n) {
    (function() {
      ...
      e = n(
        ...
        var n, r, o;
        return n = e[0], 0 === (r = C.call(e, 1)).length ? null != (o = t[n]) ? o : null : void 0 === t[n] ? null : m(t[n], r);
      }), g = function(t) {
        return 0 === l(
            p.filter(function(t) {
              return !!t;
        ...
        return E.call(t).slice(8, -1) === E.call(e).slice(8, -1) &&
          (o(function(e) {
            return u(e, t);
          })([
            'Boolean',
            ...
            'String',
            'undefined'
          ]) ? t === e : 'Array' === E.call(t).slice(8, -1) ? t.length === e.length && r(function(n) {
                  return b(t[n], e[n]);
                })(
                  (function() {
                    var e, n, r = [];
        ...
        var n, r;
        return n = E.call(e).slice(8, -1), o(function(t) {
          return t === n;
        }, [
          'Boolean',
          'Number',
          'String',
          'Function'
        ]) ? e : null === t || 'Undefined' === E.call(t).slice(8, -1) ? e : 0 === (r = p.keys(e)).length ? t : (a(function(n) {
                return t[n] = _(
        ...
        var r, o, i;
        return r = e[0], (o = C.call(e, 1)).length > 0 ? (t[r] = null != (i = t[r]) ? i : {}, x(t[r], o, n)) : (t[r] = n, t);
      }), S = function(t) {
        return c(function(e) {
          return c(function(t) {
            return t[e];
    ...
    t.exports = function(t, e, n, y, m, g) {
      ...
      if (T && !x)
        return g || (g = new r()), b || c(t)
          ...
          : i(t, e, O, n, y, m, g);
      if (!(n & p)) {
        var C = x && v.call(t, '__wrapped__'),
          E = S && v.call(e, '__wrapped__');
        if (C || E) {
          var j = C ? t.value() : t, P = E ? e.value() : e;
    ...
    o = [], void 0 === (i = 'function' == typeof (r = function() {
          ...
          var R = { center: 'center', left: 'right', right: 'left' },
            ...
            U = function(t) {
              ...
              return void 0 !== z[t.left] && (e = z[t.left]), void 0 !==
                z[t.top] &&
                (n = z[t.top]), { left: e, top: n };
            };
          function F() {
            for (
              var t = { top: 0, left: 0 },
          ...
          var H = function(t) {
            var e = t.split(' '), n = C(e, 2), r = n[0], o = n[1];
            return { top: r, left: o };
          },
            q = H,
            V = (function(r) {
              ...
              return (function(t, e) {
                ...
                },
                {
                  ...
                  value: function(t) {
                    ...
                    ), this.attachment = q(this.options.attachment), this.offset = H(this.options.offset), this.targetOffset = H(this.options.targetOffset), void 0 !== this.scrollParents && this.disable(), 'scroll-handle' === this.targetModifier ? this.scrollParents = [ this.target ] : this.scrollParents = i(this.target), !1 !== this.options.enabled && this.enable(n);
                  }
                },
                {
                  key: 'getTargetBounds',
                  ...
                  value: function() {
                    ...
                    if (this.enabled) {
                      ...
                      var u = this.cache('target-bounds', function() {
                        ...
                        l = u,
                        c = W(U(this.attachment), { width: i, height: a }),
                        d = W(U(r), l),
                      ...
                      return T.innerHeight > x.documentElement.clientHeight &&
                        (C = this.cache(
                          'scrollbar-size',
                          h
                        ), _.viewport.bottom -= C.height), T.innerWidth > x.documentElement.clientWidth && (C = this.cache('scrollbar-size', h), _.viewport.right -= C.width), -1 !== [ '', 'static' ].indexOf(x.body.style.position) && -1 !== [ '', 'static' ].indexOf(x.body.parentElement.style.position) || (_.page.bottom = x.body.scrollHeight - g - a, _.page.right = x.body.scrollWidth - m - i), void 0 !== this.options.optimizations && !1 !== this.options.optimizations.moveElement && void 0 === this.targetModifier && (function() {
          ...
          o.unmounting || (o.animationID = p.default(function(t) {
              if (!o.unmounting) {
                ...
                for (
                  ...
                  for (var C in O) if (Object.prototype.hasOwnProperty.call(O, C)) {
                      var E = O[C];
                      if ('number' == typeof E)
                        _[C] = E, x[C] = 0, S[C] = E, T[C] = 0;
                      else {
                        for (var j = g[w][C], P = b[w][C], k = 0; k < s; k++) {
                          var N = u.default(
                            v / 1e3,
                            j,
                            P,
  ...
  tjUo: function(t, e, n) {
    ...
    var u = n('Gmfh');
    Object.defineProperty(e, 'InfoButton', {
      enumerable: !0,
      get: function() {
        return f(u).default;
      }
              ...
              b(
                {
                  ...
                  scrollLock: this.state.scrollLock,
                  onScrollLockChange: function(t) {
                    return U.setState({ scrollLock: t });
                  },
                  tether: A,
                  tetherProps: I,
                  theme: D,
                  ...
                  onOpenChange: r,
                  firstOptionIndexToHighlight: function() {
                    return U.firstOptionIndexToHighlight(s, c);
                  },
                  options: s,
                  renderOption: this.props.renderOption,
                  ...
                  renderValue: function(t) {
                    return a && (U.props.editable || u.length > 0)
                      ? null
                      : U.props.renderValue(t);
                  },
                  onKeyboardSelectionFailed: function(t) {
                    return o('', function() {
                      return r(!1, function() {
                        return U.props.onKeyboardSelectionFailed(t);
                      });
                    });
                  },
                  uid: function(t) {
                    return { uid: U.props.uid(t), open: a, search: u };
                  },
                  serialize: function(t) {
                    return M(t[0]);
                  },
                  onBlur: function(t) {
                    var e, n;
                    e = U.props.onBlurResetsInput, n = function() {
                  ...
                  onFocus: function(t) {
                    U.props.onFocus({ value: c, open: a, originalEvent: t });
                  },
                  onPaste: (function() {
                    var t;
                    switch (!1) {
                      ...
                      default:
                        return function(t) {
                          var e, n;
                          if (
                            (e = t.clipboardData, n = U.props.valueFromPaste(
                              s,
                              c,
                              e.getData('text')
                            ))
              ...
              (function() {
                switch (!1) {
                  case 'function' != typeof this.props.renderNoResultsFound:
                    return {
                      renderNoResultsFound: function() {
                        return U.props.renderNoResultsFound(c, u);
                      }
                    };
                  default:
                    return {};
