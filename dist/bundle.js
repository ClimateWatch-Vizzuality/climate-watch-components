module.exports = (function(t) {
  ...
  '/g0T': function(t, e, n) {
    ...
    var c = function(t) {
      var e = t.contactMail, n = t.contactTitle, i = t.theme;
      return r.default.createElement(
        'div',
        {
          className: (0, o.default)(
            u.default.contactContainer,
            i.contactContainer
          )
        },
        r.default.createElement(
          'a',
          {
            className: (0, o.default)(u.default.contact, i.contact),
            href: 'mailto:' + e
          },
          n
        ),
    ...
    c.propTypes = {
      contactMail: i.default.string.isRequired,
      contactTitle: i.default.string,
      theme: i.default.shape({
        contactContainer: i.default.string,
        contact: i.default.string,
        icon: i.default.string
      })
    }, c.defaultProps = { contactTitle: 'CONTACT US', theme: {} }, e.default = c;
  },
  '03A+': function(t, e, n) {
    var r = n('JTzB'),
      o = n('ExA7'),
  ...
  E8yI: function(t, e) {
    t.exports = {
      contactContainer: 'cw__contact-styles_contactContainer',
      contact: 'cw__contact-styles_contact'
    };
  },
  EpBk: function(t, e) {
    t.exports = function(t) {
  ...
  JKEQ: function(t, e, n) {
    ...
    var d = (function(t) {
      function e(t) {
        ...
        return n.handleChange = function(t) {
          n.setState({ value: t }), n.debouncedChange();
        }, n.debouncedChange = (0, s.default)(
          function() {
            var t = n.props.onChange, e = n.state.search;
            t && t(e);
          },
          300
      ...
      return (function(t, e) {
        ...
        },
        {
          ...
          value: function(t) {
            ...
            t.value !== e && this.setState({ value: t.value });
          }
        },
        {
          key: 'componentDidUpdate',
          value: function(t) {
            ...
            e && e !== t.autofocus && this.inputRef.focus();
          }
        },
        {
          key: 'render',
          value: function() {
            ...
            return i.default.createElement(
              'div',
              { className: (0, u.default)(c.default.wrapper, o.wrapper) },
              i.default.createElement('input', {
                ref: function(e) {
                  t.inputRef = e;
                },
                type: 'text',
                className: (0, u.default)(c.default.input, o.input),
                placeholder: a,
                onChange: function(e) {
              ...
              r &&
                i.default.createElement(p.default, {
                  icon: r,
                  theme: { icon: (0, u.default)(c.default.icon, o.icon) }
                })
            );
          }
        }
    ...
    d.propTypes = {
      icon: a.default.oneOfType([ a.default.bool, a.default.object ]),
  ...
  QRQV: function(t, e, n) {
    ...
    var l = function(t) {
      var e = t.icon,
        n = t.theme,
        o = t.onClick,
        s = (0, i.default)(a.default.icon, n.icon, o ? a.default.cursor : '');
      return r.default.createElement(
        'svg',
  ...
  ZOtO: function(t, e, n) {
    ...
    }, u.defaultProps = { children: null, theme: {}, footerText: '' }, e.default = u;
  },
  ZWtO: function(t, e, n) {
  ...
  iDa2: function(t, e) {
    t.exports = {
      wrapper: 'cw__input-styles_wrapper',
      input: 'cw__input-styles_input',
      icon: 'cw__input-styles_icon'
    };
  },
  'k+1r': function(t, e, n) {
    var r = n('QkVE');
  ...
  sEfC: function(t, e, n) {
    var r = n('GoyQ'),
      ...
      u = Math.min;
    t.exports = function(t, e, n) {
      var l, c, p, f, d, h, v = 0, y = !1, m = !1, g = !0;
      if ('function' != typeof t) throw new TypeError(a);
      function b(e) {
        var n = l, r = c;
        return l = c = void 0, v = e, f = t.apply(r, n);
      }
      function w(t) {
        var n = t - h;
        return void 0 === h || n >= e || n < 0 || m && t - v >= p;
      }
      function O() {
        var t = o();
        if (w(t)) return _(t);
        d = setTimeout(
          ...
          (function(t) {
            var n = e - (t - h);
            return m ? u(n, p - (t - v)) : n;
          })(t)
        );
      }
      function _(t) {
        return d = void 0, g && l ? b(t) : (l = c = void 0, f);
      }
      function x() {
        var t = o(), n = w(t);
        if ((l = arguments, c = this, h = t, n)) {
          if (void 0 === d) return (function(t) {
              return v = t, d = setTimeout(O, e), y ? b(t) : f;
            })(h);
          if (m) return d = setTimeout(O, e), b(h);
        }
        return void 0 === d && (d = setTimeout(O, e)), f;
      }
      return e = i(e) ||
        0, r(n) && (y = !!n.leading, p = (m = 'maxWait' in n) ? s(i(n.maxWait) || 0, e) : p, g = 'trailing' in n ? !!n.trailing : g), x.cancel = function() {
  ...
  tjUo: function(t, e, n) {
    ...
    Object.defineProperty(e, 'Contact', {
      enumerable: !0,
      get: function() {
        return h(d).default;
      }
